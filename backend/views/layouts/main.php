...
<div class="wrapper">
    <header class="main-header">
        <a href="<?php echo Url::to(['/site/index']); ?>" class="logo">
            ...
            <span class="logo-lg"><b>Travel</b>Price</span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="<?php echo Url::to(['/enquiry']); ?>"><i class="fa fa-question-circle"></i> <span>Enquiries</span></a></li>
                <li><a href="<?php echo Url::to(['/slider']); ?>"><i class="fa fa-image"></i> <span>Sliders</span></a></li>
                <li><a href="<?php echo Url::to(['/tour']); ?>"><i class="fa fa-plane"></i> <span>Tours</span></a></li>
                <li class="treeview">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="#">
                                <i class="fa fa-circle-o"></i> Tour <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo Url::to(['/tour/package']); ?>"><i class="fa fa-circle-o"></i> Tour Packages</a></li>
                                <li><a href="<?php echo Url::to(['/tour/destination']); ?>"><i class="fa fa-circle-o"></i> Tour Destinations</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fa fa-circle-o"></i> Localisation <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo Url::to(['/localisation/country']); ?>"><i class="fa fa-circle-o"></i> Country</a></li>
                                <li><a href="<?php echo Url::to(['/localisation/state']); ?>"><i class="fa fa-circle-o"></i> State</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?php echo date('Y') ?> <a href="http://aryausa.com">Aryavrat Infotech</a>.</strong> All rights reserved.
    </footer>
