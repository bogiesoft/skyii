...
namespace modules\settings\components;
...
/**
 * Class Settings
 * @package modules\settings\components
 */
class Settings extends Component
{
     ...
     */
    public $modelClass = 'modules\settings\models\BaseSetting';

    /**
     * Model to for storing and retrieving settings
     * @var modules\settings\models\SettingInterface
     */
    protected $model;
     ...
     */
    public $cacheKey = 'modules/settings';
